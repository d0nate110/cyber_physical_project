...
public:
    static double algorithm_accuracy(const std::string&, const std::vector<std::pair<unsigned long long int, double>>&, const std::vector<std::pair<unsigned long long int, double>>&);
